...
const Images: string[] = [
	"/Images/Frame 1000002388.png",
	"/Frame 1000002387.png",
	"/Images/Frame 1000002388.png",
	"/Frame 1000002387.png",
	"/Images/LandingScrollAssets/1.svg",
	"/Images/LandingScrollAssets/1.svg",
	"/Images/LandingScrollAssets/1.svg",
	"/Images/LandingScrollAssets/1.svg",
];
	...
	return (
		<div className="mt-[94px] mb-[93px] px-6 lg:px-0">
			<div className="relative -z-10 mt-[45px] flex h-10 w-full flex-col items-center text-center lg:mt-[73px] lg:h-32">
				...
				<p className="font-kaaf absolute top-2 text-center text-base text-[#b7b7b7] lg:top-9 lg:text-[40px] lg:leading-[78.57px]">
					درباره ما
				</p>
			</div>
			<section className="mt-7">
				...
				<div className="lg:mr-44 lg:flex">
					...
					<div className="relative mt-6 lg:-right-16 lg:mt-0">
