...
const LandingPage = () => {
	return (
		<div className="mt-[94px] h-max px-6 lg:mt-0 lg:px-0">
			...
			<section className="mt-28 flex w-full lg:h-[900px] lg:flex-row lg:gap-x-[150px]">
				<div className="relative w-[700px] lg:h-[900px]">
					<CircularIcon className="-z-10 lg:absolute lg:top-0 lg:-right-[100px] lg:block lg:h-[834.78px] lg:w-[834.78px]" />
					<NaftIcon className="absolute lg:top-[30px] lg:right-[260px]" />
					<SteelIcon className="absolute lg:top-[120px] lg:right-[630px]" />
					<ZobIcon className="absolute lg:top-[200px] lg:right-[450px]" />
					<EsteghlalIcon className="absolute lg:bottom-[200px] lg:left-[80px]" />
					<SepahanIcon className="absolute lg:right-[250px] lg:bottom-0" />
					<LigIcon className="absolute lg:top-[25%] lg:left-[30%]" />
				</div>
